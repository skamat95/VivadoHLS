...
#
# Generated by export_simulation on Mon Oct 09 11:59:13 CEST 2017
#
################################################################################
...
switch to the './Make_LUT_MET_0.sh' script.

./Make_LUT_MET_0.sh -reset_run
...
./Make_LUT_MET_0.sh -noclean_files

For more information on the script, please type './Make_LUT_MET_0.sh -help'.
