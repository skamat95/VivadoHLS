...
HD_PWD='/data/skamat/Github/VivadoHLS/Make_LUT_MET/Bhawna/Vivado/ctp7_hls_demo/ctp7_hls_demo.runs/Make_LUT_MET_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Make_LUT_MET_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Make_LUT_MET_0.tcl
