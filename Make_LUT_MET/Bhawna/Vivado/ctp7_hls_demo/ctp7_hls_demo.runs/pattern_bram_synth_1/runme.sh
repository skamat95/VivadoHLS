...
HD_PWD='/data/skamat/Github/VivadoHLS/Make_LUT_MET/Bhawna/Vivado/ctp7_hls_demo/ctp7_hls_demo.runs/pattern_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_bram.tcl
