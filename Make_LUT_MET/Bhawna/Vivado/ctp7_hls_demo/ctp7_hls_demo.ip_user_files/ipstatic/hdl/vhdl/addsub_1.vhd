...
architecture behav of addsub_1 is 
    ...
    signal p_Val2_s_32_fu_48_p3 : STD_LOGIC_VECTOR (77 downto 0);
    signal tmp_s_fu_56_p1 : STD_LOGIC_VECTOR (79 downto 0);
    signal tmp_35_fu_60_p1 : STD_LOGIC_VECTOR (79 downto 0);
...
begin
    ...
    ap_return <= std_logic_vector(signed(tmp_s_fu_56_p1) + signed(tmp_35_fu_60_p1));
        b_V_cast1_fu_38_p1 <= std_logic_vector(resize(signed(b_V),78));

    p_Val2_s_32_fu_48_p3 <= 
        b_V_cast1_fu_38_p1 when (add_V(0) = '1') else 
        p_Val2_s_fu_42_p2;
    p_Val2_s_fu_42_p2 <= std_logic_vector(unsigned(ap_const_lv78_0) - unsigned(b_V_cast1_fu_38_p1));
        tmp_35_fu_60_p1 <= std_logic_vector(resize(signed(p_Val2_s_32_fu_48_p3),80));
