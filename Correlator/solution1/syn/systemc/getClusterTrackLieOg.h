...
#ifndef __getClusterTrackLieOg__HH__
#define __getClusterTrackLieOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(getClusterTrackLieOg) {
    ...
    SC_CTOR(getClusterTrackLieOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
